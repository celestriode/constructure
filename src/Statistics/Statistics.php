...
/**
 * Stores statistics generated by a structure.
 * 
 * Access to nested array structures is done via string paths:
 * 
 * addStat(1, 'path', 'to', 'stat') = ['path' => ['to' => ['stat' => 1]]]
 */
class Statistics
{
    /** @var array $statistics The stored statistics. */
    public $statistics = [];
